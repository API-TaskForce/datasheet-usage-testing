...
describe("RapidAPI - SendGrid Rate Limit Testing", () => {
  ...
  const RAPIDAPI_HOST = "rapidprod-sendgrid-v1.p.rapidapi.com";
  const RAPIDAPI_KEY = "4649fd652amshb5c1e986ad4d7bap15ae14jsn98c890147517"; // Idealmente usa process.env.RAPIDAPI_KEY
